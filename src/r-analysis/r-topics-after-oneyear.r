...
files <- list("/home/leusonmario/postdoctoral/projects/chat-stack/data/after/library/", "/home/leusonmario/postdoctoral/projects/chat-stack/data/one-year/library/")
...
files <- list("/home/leusonmario/postdoctoral/projects/chat-stack/data/after/pl/", "/home/leusonmario/postdoctoral/projects/chat-stack/data/one-year/pl/")
tags <- list("pandas", "dataframe", "arrays", "json", "jquery", "numpy", "string", "pyspark", "ggplot2", "tkinter")
pls <- list("python", "javascript", "java", "c#", "r", "php", "typescript", "c++", "dart", "c")
frameworks <- list("reactjs", "android", "node.js", "flutter", "django", "angular", "react-native", "spring-boot", "laravel", "vue.js")
...
files <- list("/home/leusonmario/postdoctoral/projects/chat-stack/data/after/framework/", "/home/leusonmario/postdoctoral/projects/chat-stack/data/one-year/framework/")
tags <- list("pandas", "dataframe", "arrays", "json", "jquery", "numpy", "string", "pyspark", "ggplot2", "tkinter")
pls <- list("python", "javascript", "java", "c#", "r", "php", "typescript", "c++", "dart", "c")
frameworks <- list("reactjs", "android", "node.js", "flutter", "django", "angular", "react-native", "spring-boot", "laravel", "vue.js")
